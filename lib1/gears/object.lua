...
local type         = type
local error        = error
local properties   = require("lib.gears.object.properties")
...
function object.add_signal()
    require("lib.gears.debug").deprecate("Use signals without explicitly adding them. This is now done implicitly.",
                                         { deprecated_in = 4 })
end
...
--      return require("lib.gears.object").modulename(2)
--  end
--  return setmetatable(ret, mt)
--
