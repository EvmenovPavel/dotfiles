...
function filesystem.mkdir(dir)
    require("lib.gears.debug").deprecate("gears.filesystem.make_directories", { deprecated_in = 5 })
...
function filesystem.get_dir(d)
    if d == "config" then
        ...
        require("lib.gears.debug").deprecate("gears.filesystem.get_xdg_config_home() .. 'awesome/'", { deprecated_in = 5 })
        return filesystem.get_xdg_config_home() .. "awesome/"
    elseif d == "cache" then
        require("lib.gears.debug").deprecate("gears.filesystem.get_cache_dir", { deprecated_in = 5 })
