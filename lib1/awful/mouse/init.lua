...
local aplace = require("lib.awful.placement")
...
local mouse  = {
    resize      = require("lib.awful.mouse.resize"),
    snap        = require("lib.awful.mouse.snap"),
    drag_to_tag = require("lib.awful.mouse.drag_to_tag")
}
