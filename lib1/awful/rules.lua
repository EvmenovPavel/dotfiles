...
local ipairs         = ipairs
local pairs          = pairs
local atag           = require("lib.awful.tag")
local gtable         = require("lib.gears.table")
local a_place        = require("lib.awful.placement")
local protected_call = require("lib.gears.protected_call")
local aspawn         = require("lib.awful.spawn")
local gsort          = require("lib.gears.sort")
...
function rules.high_priority_properties.tag(c, value, props)
    if value then
        if type(value) == "string" then
            ...
            if not value then
                require("lib.gears.debug").print_error("awful.rules-rule specified "
