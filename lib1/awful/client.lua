...
local set_shape    = require("lib.awful.client.shape").update.all
...
-- Functions
client.urgent                                = require("lib.awful.client.urgent")
client.swap                                  = {}
client.floating                              = {}
client.dockable                              = {}
client.property                              = {}
client.shape                                 = require("lib.awful.client.shape")
client.focus                                 = require("lib.awful.client.focus")
...
function client.run_or_raise(cmd, matcher, merge)
    ...
    spawn         = spawn or require("lib.awful.spawn")
