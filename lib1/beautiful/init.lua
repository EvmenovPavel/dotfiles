...
local gears_debug    = require("lib.gears.debug")
...
local gtk            = require("lib.beautiful.gtk")
    ...
    if config then
        ...
        if state then
            ...
            local err  = (file and t_theme == 'table' and "got an empty table" .. file)
                    ...
                    or ("got a " .. t_config)
            return gears_debug.print_error("lib.beautiful: error loading theme: " .. err)
        end
    else
        return gears_debug.print_error("lib.beautiful: error loading theme: no theme specified")
    end
end
