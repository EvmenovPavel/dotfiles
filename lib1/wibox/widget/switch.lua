-- Добавить SVG картинку сюда, когда юзер добавит виджет, и не передаст ничего, берест все стандатное
...
--
--
--![Usage example](../images/AUTOGEN_wibox_widget_switch_custom.svg)
--
-- 
--     wibox.widget {
--         checked       = true,
...
--
--
--![Usage example](../images/AUTOGEN_wibox_widget_defaults_switch.svg)
--
-- @usage
--         wibox.widget {
--             checked       = true,
...
-- over this property.
-- @beautiful beautiful.switch_color
...
--
--
--![Usage example](../images/AUTOGEN_wibox_widget_switch_bg.svg)
--
-- @usage
-- wibox.widget {
--     checked            = true,
...
--
--
--![Usage example](../images/AUTOGEN_wibox_widget_switch_shape.svg)
--
-- @usage
...
--
--
--![Usage example](../images/AUTOGEN_wibox_widget_switch_check_shape.svg)
--
-- @usage
-- for _, s in ipairs {'rectangle', 'circle', 'losange', 'octogon'} do
--     wibox.widget {
...
local function outline_workarea(self, width, height)
    local offset = (self._private.border_width or
            beautiful.switch_border_width or 1) / 2
...
function switch:set_paddings(val)
