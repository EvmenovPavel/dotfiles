...
local gstring        = require("lib.gears.string")
local gtable         = require("lib.gears.table")
local spawn          = require("lib.awful.spawn")
local tags           = require("lib.awful.tag")
local keygrabber     = require("lib.awful.keygrabber")
local client_iterate = require("lib.awful.client").iterate
local beautiful      = require("lib.beautiful")
local dpi            = require("lib.beautiful").xresources.apply_dpi
local object         = require("lib.gears.object")
local surface        = require("lib.gears.surface")
local protected_call = require("lib.gears.protected_call")
...
local capi           = {
    ...
    mouse  = mouse,
    client = client }
local screen         = require("lib.awful.screen")
...
local function load_theme(a, b)
    ...
    ret.border       = a.border_color or b.menu_border_color or b.border_color_normal or fallback.menu_border_color or fallback.border_color_normal
    ret.border_width = a.border_width or b.menu_border_width or b.border_width or fallback.menu_border_width or fallback.border_width or dpi(0)
    ret.fg_focus     = a.fg_focus or b.menu_fg_focus or b.fg_focus or fallback.menu_fg_focus or fallback.fg_focus
    ret.bg_focus     = a.bg_focus or b.menu_bg_focus or b.bg_focus or fallback.menu_bg_focus or fallback.bg_focus
    ret.fg_normal    = a.fg_normal or b.menu_fg_normal or b.fg_normal or fallback.menu_fg_normal or fallback.fg_normal
    ret.bg_normal    = a.bg_normal or b.menu_bg_normal or b.bg_normal or fallback.menu_bg_normal or fallback.bg_normal
    ret.submenu_icon = a.submenu_icon or b.menu_submenu_icon or b.submenu_icon or fallback.menu_submenu_icon or fallback.submenu_icon
    ret.submenu      = a.submenu or b.menu_submenu or b.submenu or fallback.menu_submenu or fallback.submenu or "▶"
    ret.height       = a.height or b.menu_height or b.height or fallback.menu_height or dpi(16)
    ret.width        = a.width or b.menu_width or b.width or fallback.menu_width or dpi(100)
...
local function set_coords(_menu, s, m_coords)
    ...
    _menu.wibox.x    = screen_w / 2 - _menu.width / 2
    _menu.wibox.y    = screen_h / 2 - _menu.height / 2
end
