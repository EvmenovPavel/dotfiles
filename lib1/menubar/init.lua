...
local common  = require("lib.awful.widget.common")
local theme   = require("lib.beautiful")
local wibox   = require("lib.wibox")
local gcolor  = require("lib.gears.color")
...
menubar.menu_gen         = require("lib.menubar.menu_gen")
menubar.utils            = require("lib.menubar.utils")
