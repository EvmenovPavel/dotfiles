...
local ICONS_DIR       = resources.path
local ICON            = '/awesome.png'
            ...
            awful.util.table.join(
                    awful.button({}, 1, function()
                        if wibox_popup.visible then
                            ...
                            spawn.easy_async(ACTIVE_MONITORS, function(out, err)
                                active_monitors = out
                                spawn.easy_async(MONITORS, function(stdout, stderr)
...
return setmetatable(xrandr_widget, { __call = function(_, ...)
    return worker(...)
end })
