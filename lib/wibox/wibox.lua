...
wibox.layout        = require("lib.wibox.layout")
wibox.container     = require("lib.wibox.container")
wibox.widget        = require("lib.wibox.widget")
wibox.drawable      = require("lib.wibox.drawable")
wibox.hierarchy     = require("lib.wibox.hierarchy")
