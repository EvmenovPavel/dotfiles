...
--
--    awesome-client 'awful=require("lib.awful");
--      awful.spawn("urxvt -e maxima -name CALCULATOR", {
--        floating  = true,
--        tag       = mouse.screen.selected_tag,
--        placement = awful.placement.bottom_right,
...
local aclient        = require("lib.awful.client")
...
do
    ...
    elseif tostring(line) == "" and #line ~= length then
        ...
        -- EOF in this case.
        require("lib.gears.debug").print_warning("Cannot reliably detect EOF on an "
...
return setmetatable(spawn, { __call = function(_, ...)
    return spawn.spawn(...)
end })
