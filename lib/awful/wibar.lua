...
function awfulwibar.set_position(wb, position, workarea, screen)
...
function awfulwibar.attach(wb, position, workarea, screen)
    --luacheck: no unused args
...
function awfulwibar.align(wb, align, workarea, screen)
    --luacheck: no unused args
