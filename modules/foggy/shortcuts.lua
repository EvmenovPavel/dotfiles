local shortcuts     = {
	_NAME = "modules.foggy.shortcuts"
}

local set_backlight = require('modules.foggy.xrandr').actions.set_backlight
local get_output    = require('modules.foggy.menu').get_output
