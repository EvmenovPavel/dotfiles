...
local math           = math
local base           = require("widgets.radical.base")
local color          = require("gears.color")
local wibox          = require("wibox")
local beautiful      = require("beautiful")
local vertical       = require("widgets.radical.layout.vertical")
local horizontal     = require("widgets.radical.layout.horizontal")
local item_layout    = require("widgets.radical.item.layout.icon")
local item_style     = require("widgets.radical.item.style.rounded")
local hot_corner     = require("widgets.radical.hot_corner")
local shape          = require("gears.shape")
local common         = require("widgets.radical.common")
local smart_wibox    = require("widgets.radical.smart_wibox")
...
local default_shape  = function(cr, width, height)
    shape.partially_rounded_rect(cr, width, height, false, true, true, false, rad)
end
...
local function get_wibox(data, screen)
    if data._internal.w then
        return data._internal.w
    end
