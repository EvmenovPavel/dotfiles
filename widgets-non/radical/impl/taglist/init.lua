...
local tag_menu    = require("widgets.radical.impl.taglist.tag_menu")
...
local function track_used(c, t)
    if t and t.activated then
        ...
        if not item then
            return
        end -- Yes, it happen if the screen is still nil
