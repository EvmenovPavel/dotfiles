...
local module    = {
    -- style  = require( "widgets.radical.item.style"),
    -- layout = require( "widgets.radical.item.layout"),
    arrow_type = {
        NONE     = 0,
        PRETTY   = 1,
        CENTERED = 2,
...
local function load_async(tab, key)
    if key == "style" then
        module.style = require( "widgets.radical.item.style")
        return module.style
    elseif key == "layout" then
        module.layout = require( "widgets.radical.item.layout")
