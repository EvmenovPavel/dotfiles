...
local glib        = require("lib.lgi").GLib
local beautiful   = require("lib.beautiful")
local color       = require("lib.gears.color")
local placement   = require("lib.awful.placement")
...
function wb_func:move_by_parent(geo, mode)
    if rawget(self, "is_relative") == false then
        return
    end
