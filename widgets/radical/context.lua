...
local arrow_style  = require("widgets.radical.style.arrow")
...
local function new(args)
    ...
    -- Accessors
    data.get_wibox       = function()
        return internal.w
    end
    data.get_visible     = function()
        return internal.private_data.visible
    end
    data.get_screen      = function()
        return internal.w.screen
    end
