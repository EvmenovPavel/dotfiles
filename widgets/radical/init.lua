...
local tooltip   = require("widgets.radical.tooltip")
...
local bar         = require("widgets.radical.bar")

return {
    layout  = require("widgets.radical.layout"),
    object  = require("widgets.radical.object"),
    base    = require("widgets.radical.base"),
    radial  = require("widgets.radical.radial"),
    context = require("widgets.radical.context"),
    embed   = require("widgets.radical.embed"),
    box     = require("widgets.radical.box"),
    style   = require("widgets.radical.style"),
    widgets = require("widgets.radical.widgets"),
    item    = require("widgets.radical.item"),
    dock    = require("widgets.radical.dock"),
    bar     = bar,
    flexbar = bar.flex,
    tooltip = tooltip
}
