...
local fkey         = require("widgets.radical.widgets.fkey")
local infoshapes   = require("widgets.radical.widgets.infoshapes")
local util         = require("awful.util")
local margins2     = require("widgets.radical.margins")
local shape        = require("gears.shape")
local surface      = require("gears.surface")
local common       = require("widgets.radical.item.common")
