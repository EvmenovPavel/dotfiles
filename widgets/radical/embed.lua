...
local layout        = require("widgets.radical.layout")
local classic_style = require("widgets.radical.style.classic")
...
local function new(args)
    ...
    data.get_visible = function()
        return data._embeded_parent and data._embeded_parent.visible or false
    end
    data.set_visible = function(_, v)
        if data._embeded_parent then
            data._embeded_parent.visible = v
        end
    end
