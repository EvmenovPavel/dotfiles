...
local function add_focus(calendarbutton)
    data[calendarbutton].next_month.widget:connect_signal("mouse::enter", function()
        apply_style(data[calendarbutton].next_month.widget, data[calendarbutton].focus_widget_style)
    end)
    data[calendarbutton].next_month.widget:connect_signal("mouse::leave", function()
        apply_style(data[calendarbutton].next_month.widget, data[calendarbutton].prev_next_widget_style)
    end)
    data[calendarbutton].prev_month.widget:connect_signal("mouse::enter", function()
        apply_style(data[calendarbutton].prev_month.widget, data[calendarbutton].focus_widget_style)
    end)
    data[calendarbutton].prev_month.widget:connect_signal("mouse::leave", function()
        apply_style(data[calendarbutton].prev_month.widget, data[calendarbutton].prev_next_widget_style)
    end)
    data[calendarbutton].date.widget:connect_signal("mouse::enter", function()
        apply_style(data[calendarbutton].date.widget, data[calendarbutton].focus_widget_style)
    end)
    data[calendarbutton].date.widget:connect_signal("mouse::leave", function()
        apply_style(data[calendarbutton].date.widget, data[calendarbutton].current_date_widget_style)
    end)
...
local function fill_calendar(calendarbutton)
    ...
    if first_day_of_current_month == 0 then
        first_day_of_current_month = 7
    end
